...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get supportCommunity => 'Soutenir la communauté BookBridge';
  ...
  String get termsPaymentsContent =>
      'Les paiements pour les livres sont généralement gérés en espèces à la livraison ou via un transfert direct d\'argent mobile entre l\'acheteur et le vendeur. BookBridge peut proposer des solutions de paiement intégrées (comme CamPay) pour des services spécifiques ou des dons.';
